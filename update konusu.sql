...
--'casper' ve irtibat_ismi’ni 'Ali Veli' olarak güncelleyiniz.
update tedarikciler
...
where urun_isim='Phone'
 ...
 --SORU
 --  urunler tablosundaki urun_id değeri 
 --1004'ten büyük olanların urun_id’sini 1 arttırın
 update urunler
...
--NOT:butun degerleri istedigimiz icin WHERE koymadik degil mi hocam
update urunler
...
--NOT: Bu soruda tedarikciler ve urun tablosunu yeniden olusturduk
update urunler
